...
CFLAGS = -O2 -mno-red-zone -ffreestanding -fno-exceptions -fno-stack-protector -fpic -g -I ../libfoxos/include -I ../libc/include -I ../libtinf/include -Iinclude  -fdata-sections -ffunction-sections
CPPFLAGS = $(CFLAGS)
LDFLAGS = -pic $(BUILDDIR)/libfoxos.a.o $(BUILDDIR)/libc.a.o $(BUILDDIR)/libtinf.a.o --gc-sections
