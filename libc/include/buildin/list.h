...
EXPOSEC struct list_node_t* __libc_list_create(uint64_t data, struct list_node_t* next);
EXPOSEC void __libc_list_traverse(struct list_node_t* head, __libc_list_callback f);
EXPOSEC struct list_node_t* __libc_list_append(uint64_t data, struct list_node_t* head);
