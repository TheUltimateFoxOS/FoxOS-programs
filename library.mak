...
CFLAGS = -O2 -mno-red-zone -ffreestanding -fno-exceptions -fpic -g -I ../libfoxos/include -Iinclude -I../libc/include -I../libtinf/include -I../libcfg/include -nostdinc -fno-stack-protector -fdata-sections -ffunction-sections
CPPFLAGS = $(CFLAGS)
LDFLAGS = -r
